...
namespace LpApiIntegration.Db.Migrations
{
    ...
    [Migration("20230105074113_InitialCreation")]
            ...
            modelBuilder.Entity("LpApiIntegration.Db.Db.Models.GradingModel", b =>
                {
                    ...
                    b.Property<int>("BestCourseSelectionMeritSort")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GradedProgramEnrollmentId");
            ...
            modelBuilder.Entity("LpApiIntegration.Db.Db.Models.GradingModel", b =>
                {
                    ...
                    b.HasOne("LpApiIntegration.Db.Db.Models.ProgramEnrollmentModel", "ProgramEnrollment")
                        .WithMany()
                        .HasForeignKey("GradedProgramEnrollmentId");
